//C:\Users\User\mini-crm\src\pages\dashboard\DashboardServer.tsx
import { db } from '../../firebase' // В Next тут будет серверный конфиг
import { collection, getDocs, query, where } from 'firebase/firestore'
import DashBoardPage from './DashBoardPage'
import { DashboardTypes } from '../../types/task'
